...
function shareCard() {
    ...
    if (navigator.share) {
        navigator.share({
            title: 'Anthony - Always Trucking & Loading LLC',
            text: 'Contact information for Anthony, Owner/Instructor at Always Trucking & Loading LLC',
...
END:VCARD`;
    ...
    link.href = url;
    link.download = 'anthony_contact.vcf';
